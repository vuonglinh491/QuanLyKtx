    ...
    public partial class MyRoomForm : Form
    {
        ...
        private void LoadRoomData()
        {
            ...
            try
            {
                ...
                var dtRoom = DatabaseHelper.ExecuteQuery(sqlRoom, new[] { new SqlParameter("@StudentID", Session.StudentID.Value) });
                ...
                var dtRoommates = DatabaseHelper.ExecuteQuery(sqlRoommates, new[] { new SqlParameter("@RoomID", roomId) });
